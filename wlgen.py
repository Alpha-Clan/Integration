...
def print_cow():
    print(" ___________ ")
    print("  \033[07m  WL GEN! \033[27m                # \033[07mW\033[27mord")
    print("      \                     # \033[07mL\033[27mist")
    print("       \   \033[1;31m,__,\033[1;m\033[27m")
    print(
        "        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # \033[07mG\033[27menerator"
    )
    print("           \033[1;31m(__)    )\ \033[1;m  ")
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ TEAM ALPHA CLAN | CYBER LAB BIT ]"
    )
    print(28 * " " + "[ WL GEN | an initiative by CYBER LAB ]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ wlgen.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* WordList Generator makes easier to Bruteforce")
    print("	* Creates Wordlist on the specific Target\r\n")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in wlgen.cfg too...
    ...
    print_to_file(file_to_open + ".wlgen.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the wlgen utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "wlgen.cfg"))
